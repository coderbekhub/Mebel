    ...
    <section className='provideSection' id='taminlash'>
      <div className="container">
        ...
        <div className='provideContent row'>
          <div data-aos="fade-right" className="provideInfo col-md-4 col-12">
          ...
          <div data-aos="fade-down" className="provideInfo col-md-4 col-12">
          ...
          <div data-aos="fade-left" className="provideInfo col-md-4 col-12">
